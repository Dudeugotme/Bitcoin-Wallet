...
import (
	...
	"github.com/Dudeugotme/Bitcoin-Wallet/api"
...
func SetupCli(parser *flags.Parser) {
	...
	parser.AddCommand("currentaddress",
		...
		"Returns the first unused address in the keychain\n\n"+
			...
			"Examples:\n"+
			"> btcwallet currentaddress\n"+
			"1DxGWC22a46VPEjq8YKoeVXSLzB7BA8sJS\n"+
			"> btcwallet currentaddress internal\n"+
	...
	parser.AddCommand("newaddress",
		...
		"Returns a new unused address in the keychain. Use caution when using this function as generating too many new addresses may cause the keychain to extend further than the wallet's lookahead window, meaning it might fail to recover all transactions when restoring from seed. CurrentAddress is safer as it never extends past the lookahead window.\n\n"+
			...
			"1. purpose       (string default=external) The purpose for the address. Can be external for receiving from outside parties or internal for example, for change.\n\n"+
			"Examples:\n"+
			"> btcwallet newaddress\n"+
			"1DxGWC22a46VPEjq8YKoeVXSLzB7BA8sJS\n"+
			"> btcwallet newaddress internal\n"+
			"18zAxgfKx4NuTUGUEuB8p7FKgCYPM15DfS\n",
		&newAddress)
	...
	parser.AddCommand("haskey",
		...
		"Returns whether a key for the given address exists in the wallet\n\n"+
			...
			"Examples:\n"+
			"> btcwallet haskey 1DxGWC22a46VPEjq8YKoeVXSLzB7BA8sJS\n"+
			"true\n",
		&hasKey)
	...
	parser.AddCommand("gettransaction",
		...
		"Returns json data of a specific transaction\n\n"+
			...
			"Examples:\n"+
			"> btcwallet gettransaction 190bd83935740b88ebdfe724485f36ca4aa40125a21b93c410e0e191d4e9e0b5\n",
		&getTransaction)
	parser.AddCommand("getfeeperbyte",
		...
		"Returns the current network fee per byte for the given fee level.\n\n"+
			...
			"Examples:\n"+
			"> btcwallet getfeeperbyte\n"+
			"140\n"+
			"> btcwallet getfeeperbyte priority\n"+
			"160\n",
		&getFeePerByte)
	parser.AddCommand("spend",
		...
		"Send bitcoins to the given address\n\n"+
			...
			"Examples:\n"+
			"> btcwallet spend 1DxGWC22a46VPEjq8YKoeVXSLzB7BA8sJS 1000000\n"+
			"82bfd45f3564e0b5166ab9ca072200a237f78499576e9658b20b0ccd10ff325c"+
			"> btcwallet spend 1DxGWC22a46VPEjq8YKoeVXSLzB7BA8sJS 3000000000 priority\n"+
			"82bfd45f3564e0b5166ab9ca072200a237f78499576e9658b20b0ccd10ff325c",
		&spend)
	parser.AddCommand("bumpfee",
		...
		"Bumps the fee on an unconfirmed transaction\n\n"+
			...
			"Examples:\n"+
			"> btcwallet bumpfee 190bd83935740b88ebdfe724485f36ca4aa40125a21b93c410e0e191d4e9e0b5\n"+
			"82bfd45f3564e0b5166ab9ca072200a237f78499576e9658b20b0ccd10ff325c",
		&bumpFee)
	...
	parser.AddCommand("addwatchedscript",
		...
		"Add a script of bitcoin address to watch\n\n"+
			...
			"Examples:\n"+
			"> btcwallet addwatchedscript 1DxGWC22a46VPEjq8YKoeVXSLzB7BA8sJS\n"+
			"> btcwallet addwatchedscript 76a914f318374559bf8296228e9c7480578a357081d59988ac\n",
		&addWatchedScript)
	parser.AddCommand("getconfirmations",
		...
		"Returns the number of confirmations for the given transaction\n\n"+
			...
			"Examples:\n"+
			"> btcwallet getconfirmations 190bd83935740b88ebdfe724485f36ca4aa40125a21b93c410e0e191d4e9e0b5\n"+
			"6\n",
		&getConfirmations)
	parser.AddCommand("sweepaddress",
		...
		"Completely empty an address into a different one\n\n"+
			...
			"}\n\n"+
			"Examples:\n"+
			`> btcwallet sweepaddress "{"utxos":["txid": "82bfd45f3564e0b5166ab9ca072200a237f78499576e9658b20b0ccd10ff325c", "index": 0, "value": 1000000], "address": "1DxGWC22a46VPEjq8YKoeVXSLzB7BA8sJS", "key": "KzSg35HS67h4e7NLEywc3gNydjbRjzsyrPH5D7G8rpgv9qQCnb3S", "redeemScript": "1f6eb0660aab25ffe35978e7cb6e31bf40e1cceaf29c7f4f118cd2d76c2088237cb33c75510b8be669d90c01b0c394477690ff9c8388bcec4d71c3855fa50beb", "feeLevel":"priority"}"`+"\n"+
			"12c56cfcdc0249002c2a4b1f7fd957c7149fc45d0e9920594c7c78c17dcc34bd\n\n"+
			`> btcwallet sweepaddress "{"utxos":["txid": "82bfd45f3564e0b5166ab9ca072200a237f78499576e9658b20b0ccd10ff325c", "index": 0, "value": 1000000], "address": "1DxGWC22a46VPEjq8YKoeVXSLzB7BA8sJS", "key": "xprvA2nrNbFZABcdryreWet9Ea4LvTJcGsqrMzxHx98MMrotbir7yrKCEXw7nadnHM8Dq38EGfSh6dqA9QWTyefMLEcBYJUuekgW4BYPJcr9E7j", "feeLevel":"priority"}"`+"\n"+
			"12c56cfcdc0249002c2a4b1f7fd957c7149fc45d0e9920594c7c78c17dcc34bd\n\n"+
			`> btcwallet sweepaddress "{"utxos":["txid": "82bfd45f3564e0b5166ab9ca072200a237f78499576e9658b20b0ccd10ff325c", "index": 0, "value": 1000000], "address": "1DxGWC22a46VPEjq8YKoeVXSLzB7BA8sJS", "key": "be93c7096dc03bd495894140ff7fee894fbf6c944980d26f8f1cb12cc54316c7"}"`+"\n"+
			"12c56cfcdc0249002c2a4b1f7fd957c7149fc45d0e9920594c7c78c17dcc34bd\n\n"+
			`> btcwallet sweepaddress "{"utxos":["txid": "82bfd45f3564e0b5166ab9ca072200a237f78499576e9658b20b0ccd10ff325c", "index": 0, "value": 1000000], "key": "be93c7096dc03bd495894140ff7fee894fbf6c944980d26f8f1cb12cc54316c7"}"`+"\n"+
			"12c56cfcdc0249002c2a4b1f7fd957c7149fc45d0e9920594c7c78c17dcc34bd",
		&sweepAddress)
	parser.AddCommand("resyncblockchain",
		...
		"Will download all headers from the given height. Try this to uncover missing transasctions\n\n"+
			...
			"Examples:\n"+
			"> btcwallet resyncblockchain 400000\n"+
			"> btcwallet resyncblockchain",
		&reSyncBlockchain)
	...
	parser.AddCommand("estimatefee",
		...
		"Given a transaction estimate what fee it will cost in satoshis\n\n"+
			...
			"}\n\n"+
			"Examples:\n"+
			`> btcwallet estimatefee "{"inputs":["txid": "82bfd45f3564e0b5166ab9ca072200a237f78499576e9658b20b0ccd10ff325c", "index": 0], "outputs":["scriptPubKey": "76a914f318374559bf8296228e9c7480578a357081d59988ac", "value": 1000000], "feePerByte": 140}"`+"\n"+
			"18500\n",
		&estimateFee)
}
...
func (x *DumpHeaders) Execute(args []string) error {
	if len(args) <= 0 {
		...
		db, err := btcwallet.NewHeaderDB(args[0])
		if err != nil {
			fmt.Println(err)
		} else {
			db.Print(os.Stdout)
